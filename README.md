...
Add to the project’s "build.gradle" or "build.gradle.kts" file:
    ...
    dependencies {
        implementation("com.github.stephengold:Wes:0.8.3")
    }
...
+ https://github.com/stephengold/Heart/releases/tag/9.3.0
...
5. Add the [Heart] class jar:
  ...
  + Select the "Heart-9.3.0.jar" file.
  + Click on the "Open" button.
6. (optional) Add jars for javadoc and sources:
  + Click on the "Edit" button.
  + Click on the "Browse..." button to the right of "Javadoc:"
  + Select the "Heart-9.3.0-javadoc.jar" file.
  + Click on the "Open" button.
  + Click on the "Browse..." button to the right of "Sources:"
  + Select the "Heart-9.3.0-sources.jar" file.
